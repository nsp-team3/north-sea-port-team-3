...
export default class VesselSearch extends Search {
    ...
    protected displayResult(searchResultsElement: HTMLTableElement, searchResult: VesselSearchResult): void {
        ...
        div.addEventListener("click", async () => {
            const vesselDetails = await VesselAPI.getDetails(searchResult.mmsi);
            console.log(vesselDetails);
            console.log("TODO: Show vesselDetails in sidebar.");
            console.log("TODO: Fly to vessel?");
            // const simpleVesselInfo = await VesselAPI.getLocationInfo(searchResult.mmsi);
        });
